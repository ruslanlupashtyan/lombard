...
let productYear = new SlimSelect({
  select: "#auto_type",
  settings: {
    placeholderText: "Оберіть розмір",
    showSearch: false,
...
let yearValues = productYear.getSelected();
var testbtn = document.querySelector(".map .create-direction");
...
var values = select.getData();
// var testbtn = document.querySelector(".map .create-direction");
// testbtn.addEventListener("click", function () {
//   console.log(values[1].selected);
//   // select.destroy();
// });
